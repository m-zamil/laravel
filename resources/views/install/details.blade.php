...
<div class="container">
    <div class="row">
        <h3 class="text-center">{{ config('', 'Pharma POS') }} Installation <small>Step 2 of 3</small></h3>
              ...
              <form class="form" id="details_form" method="post" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="APP_NAME" id="app_name" placeholder="Pharma POS" value="Pharma POS" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="APP_TITLE" class="form-control" id="app_title" value="Pharma POS - Best ERP, Stock Management, Point of Sale & Invoicing application
">
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_purchase_code">License Purchase Code:*</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="ENVATO_USERNAME" required class="form-control" id="envato_username" value="Muzamil Khan">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS" placeholder="hello@pharmapos.com" value="admin@pharmapos.com" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="MAIL_FROM_NAME" name="MAIL_FROM_NAME" placeholder="Pharma POS (Optional)">
                    </div>
                  </div>
