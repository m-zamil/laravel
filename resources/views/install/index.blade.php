...
<div class="container">
    ...
    <div class="row">
      <h3 class="text-center">{{ config('', ' Pharma POS') }} Installation <small>Step 1 of 3</small></h3>
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <ol>
                <li>
                  <b>Step-by-Step document</b> - <a href="">Documentation</a>
                </li>
                <li>
                ...
                <li>
                  ...
                  <ul>
                    <li><b>License purchase code.</b> (<a href="">Where Is My Purchase Code?</a>)</li>
